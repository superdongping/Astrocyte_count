function [hole_area,hole_area_hist]=Astrocyte_Count(tif_filename)
close all;
% tif_filename;
...
figure(3)
%% 
I_BW_m = medfilt2(I_BW,[4,4]); % Medium Filter, get rid of pepper noise
imshow(I_BW_m)
...
pos = ([S.Area] <= 2000) & ([S.Area] >= 15);  % To be set the area threshold
pos_ex = ~pos;
...
xls_filename = [tif_filename 'area_size.xlsx'];
